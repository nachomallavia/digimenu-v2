...
- Domain types: `src/lib/domain`
- Queries/mutations: `src/lib/server/db` — see `src/lib/server/db/db.md`

### Owner tenancy (DIG-13)

- `requireOwner` → `owner_restaurants` (no cookie in Alpha)
