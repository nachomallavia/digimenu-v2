...
| `bootProductosEditor` | Products list: Nanostores pending map, search/category filter, batch `products.batchUpdate`, row image/delete (DIG-20) |
...
- Search + native category filter (no tag multi-filter, pager, or CSV — DIG-21)
